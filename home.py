...
#             text="Sync from Server", icon=ft.Icons.DOWNLOAD, on_click=self.add_asset_dialog.sync_from_server,
#             bgcolor=ft.Colors.PURPLE_500, color=ft.Colors.WHITE, width=300, height=50
#         )
#         self.sync_upload_button = ft.ElevatedButton(
#             text="Sync Upload", icon=ft.Icons.UPLOAD, on_click=self.add_asset_dialog.sync_to_server,
...
#         )
#         self.sync_from_server_button = ft.ElevatedButton(
#             text="Sync from Server", icon=ft.Icons.DOWNLOAD, on_click=lambda e: sync_from_server(self.local_db, self.page),
#             bgcolor=ft.Colors.PURPLE_500, color=ft.Colors.WHITE, width=300, height=50
#         )
#         self.sync_upload_button = ft.ElevatedButton(
#             text="Sync Upload", icon=ft.Icons.UPLOAD, on_click=lambda e: sync_to_server(self.local_db, self.page),
#             bgcolor=ft.Colors.PINK_500, color=ft.Colors.WHITE, width=300, height=50
#         )
